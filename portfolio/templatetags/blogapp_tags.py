...
@register.inclusion_tag('portfolio/components/tags_list.html', takes_context=True)
...
@register.inclusion_tag('portfolio/components/categories_list.html', takes_context=True)
...
@register.inclusion_tag('portfolio/components/post_categories_list.html', takes_context=True)
...
@register.inclusion_tag('portfolio/components/post_tags_list.html', takes_context=True)
...
@register.inclusion_tag('portfolio/comments/disqus.html', takes_context=True)
